...
![PMF of Binomial distribution with $n = 10$ and
$p = \frac{1}{6}$.](_main_files/figure-html/pmf_plot.png){width="80%"}

![PMF of Binomial distribution with $n = 50$ and
$p = \frac{1}{6}$.](_main_files/figure-html/pmf_n50.png){width="80%"}

![PMF of Binomial distribution with $n = 100$ and
$p = \frac{1}{6}$.](_main_files/figure-html/pmf_n100.png){width="80%"}

![PMF of Binomial distribution with $n = 300$ and
$p = \frac{1}{6}$.](_main_files/figure-html/pmf_n300.png){width="80%"}
...
![Binomial distribution with $n = 300$, $p = \frac{1}{6}$ and its Normal
approximation.](_main_files/figure-html/binomial_normal.png){width="90%"}
