...
![Regression line with normal errors at each
$X$](section16/images/regression_model.pdf){width="60%"}
...
![Plot of Price vs Area for Apartments near
UTM](section16/images/utm_apartments.pdf){width="60%"}
...
![Residual Plots - Good and Bad
Examples](section16/images/residual_plots.pdf){width="100%"}
