...
![Simulation of running sample mean of Bernoulli($p = 0.5$) trials over
time.](Section5/images/simulation_plot.pdf){width="72%"}
...
![Simulation of 10 running sample means of Bernoulli($p = 0.5$) trials
converging over 100
trials.](Section5/images/simulation_multi.pdf){width="72%"}
