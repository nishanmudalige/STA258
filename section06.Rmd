...
![Simulated 95% confidence intervals for the population mean. Red "X"
marks indicate intervals that do not contain the true mean
($\mu = 0$).](Section6/images/confidence_intervals.pdf){width="60%"}
...
![The central area under the standard normal curve with confidence level
$C$.](Section6/images/normal_confidence_curve.pdf){width="60%"}
