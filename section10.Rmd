...
<figure>
```{r fig-mu1-lt-mu2, fig.cap = "Visualization of two-sample confidence interval (Case 1, 2, 3)", out.width = "80%", echo = FALSE}
knitr::include_graphics("figures/Ca1-1.png")
```
<figcaption>Visualization of two-sample confidence interval (Case 1, 2,3) </figcaption>
</figure>
...
::: center
<figure>
```{r fig-mu1-lt-mu2-2, fig.cap = "Visualization of the case when μ₁ < μ₂", out.width = "80%", echo = FALSE}
knitr::include_graphics("figures/Ca1-1.png")
```
...
::: center
<figure>
```{r fig-mu1-lt-mu2-3, fig.cap = "Visualization of the case when μ₁ > μ₂", out.width = "80%", echo = FALSE}
knitr::include_graphics("figures/Ca2-1.png")
```
<figcaption>Visualization of the case when <span
class="math inline"><em>μ</em><sub>1</sub> &gt; <em>μ</em><sub>2</sub></span></figcaption>
</figure>
...
::: center
<figure>
```{r fig-mu1-lt-mu2-4, fig.cap = "Visualization of the case when μ₁ = μ₂", out.width = "80%", echo = FALSE}
knitr::include_graphics("figures/Ca3-1.png")
```
<figcaption>Visualization of the case when <span
class="math inline"><em>μ</em><sub>1</sub> = <em>μ</em><sub>2</sub></span></figcaption>
</figure>
...
::: center
<figure>
```{r fig-mu1-lt-mu2-5, fig.cap = "Visualization of the case when $\bar{M}_1 < \bar{M}_2$", out.width = "80%", echo = FALSE}
knitr::include_graphics("figures/pa1-1.png")
```
<figcaption>Visualization of the case when <span
...
::: center
<figure>
```{r fig-mu1-lt-mu2-6, fig.cap = "Visualization of the case when $\bar{M}_1 > \bar{M}_2$", out.width = "80%", echo = FALSE}
knitr::include_graphics("figures/pa2-1.png")
```
<figcaption>Visualization of the case when <span
class="math inline"><em>M̄</em><sub>1</sub> &gt; <em>M̄</em><sub>2</sub></span></figcaption>
</figure>
...
::: center
<figure>
```{r fig-mu1-lt-mu2-7, fig.cap = "The mean $\bar{M}_1$ is equal to $\bar{M}_2$.", out.width = "80%", echo = FALSE}
knitr::include_graphics("figures/pa3-1.png")
```
<figcaption>Visualization of the case when <span
class="math inline"><em>M̄</em><sub>1</sub> = <em>M̄</em><sub>2</sub></span></figcaption>
</figure>
...
::: center
<figure>
```{r fig-mu1-lt-mu2-8, fig.cap = "Visualization of two population of all students from UTSG (left) and UTM (right).", out.width = "80%", echo = FALSE}
...
::: center
<figure>
```{r fig-mu1-lt-mu2-9, fig.cap = "Visualization of two selected random sample from UTSG (left) and UTM (right).", out.width = "80%", echo = FALSE}
...
::: center
<figure>
```{r fig-mu1-lt-mu2-10, fig.cap = "Visualization of the case when $p_1 > p_2$.", out.width = "80%", echo = FALSE}
knitr::include_graphics("figures/po1-1.png")
```
<figcaption>Visualization of the case when <span
...
::: center
<figure>
```{r fig-mu1-lt-mu2-11, fig.cap = "Visualization of the case when $p_1 < p_2$.", out.width = "80%", echo = FALSE}
knitr::include_graphics("figures/po2-1.png")
```
<figcaption>Visualization of the case when <span
class="math inline"><em>p</em><sub>1</sub> &lt; <em>p</em><sub>2</sub></span></figcaption>
</figure>
...
::: center
<figure>
```{r fig-mu1-lt-mu2-12, fig.cap = "Visualization of the case when $p_1 = p_2$.", out.width = "80%", echo = FALSE}
knitr::include_graphics("figures/po3-1.png")
```
<figcaption>Visualization of the case when <span
