...
::: center
<figure>
```{r fig-mu1-lt-mu1, fig.cap = "Visualization of two-sample confidence interval (Case 1, 2, 3)", out.width = "80%", echo = FALSE}
knitr::include_graphics("ch10/two-sample-ci-1.png")
```
