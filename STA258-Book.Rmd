...
![Visualization of left skew probability
distribution](Section1/img/Leftskew.jpg)
...
![Visualization of right skew probability
distribution](Section1/img/Rightskew.jpg)
...
![Visualization of symmetric probability
distribution](Section1/img/Symmetry.jpg)
...
![Visualization of a histogram has a left (or negative) skew probability
distribution](Section1/img/HisL.jpg)

For a histogram to have a right (or positive) skew probability
distribution:

![Visualization of a histogram has a right (or positive) skew
probability distribution](Section1/img/HisR.jpg)

For a histogram to have a symmetric probability distribution:

![Visualization of a histogram has a symmetric probability
distribution](Section1/img/HisS.jpg)
