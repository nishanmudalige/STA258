...
```{r echo=FALSE, fig.cap="Simulation of running sample mean of Bernoulli \\(p = 0.5\\) trials over time.", out.width='80%', fig.align='center'}
knitr::include_graphics("Working Text/Section5/images/simulation_plot.png")
```
...
```{r echo=FALSE, fig.cap="Simulation of 10 running sample means of Bernoulli \\(p = 0.5\\) trials converging over 100 trials.", out.width='80%', fig.align='center'}
knitr::include_graphics("Working Text/Section5/images/simulation_multi.png")
```
