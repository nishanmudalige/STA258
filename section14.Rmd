...
![Q-Q Plot for Group 1: Interaction with
Outsiders](section14/images/qqplot_group1.pdf){#fig:qqplot-group1
width="60%"}
...
::: minipage
![image](section14/images/qqplot_group2.pdf){width="60%"}

[]{#fig:qqplot-group2 label="fig:qqplot-group2"}
:::
...
::: minipage
![image](section14/images/boxplot_success_index.pdf){width="55%"}
...
![Boxplot of Success Index by Group using
ggplot2](section14/images/boxplot_ggplot2.pdf){#fig:boxplot-ggplot
width="60%"}
...
![Q-Q Plot for Treatment
Group](section14/images/treatment_qqplot.pdf){#fig:qqplot-ggplot
width="60%"}
...
::: minipage
![image](section14/images/control_qqplot.pdf){width="60%"}

[]{#fig:qqplot-ggplot label="fig:qqplot-ggplot"}
:::
