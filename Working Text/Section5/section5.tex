...
\textit{[Slide Image from Slide 10 will be inserted here — Single Trial Simulation]}

\textit{[Slide Image from Slide 13 will be inserted here — Empirical Probability Explanation]}
