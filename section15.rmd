...
are measures of height monthly, and the red line is our SLR model. In
this case <span class="math inline"><em>m</em></span> is the slope which
tells you the rate of change, <span
class="math inline"><em>b</em></span> is the intercept which may have a
special meaning depending on the case.</figcaption>
</figure>
