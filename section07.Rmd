...
- As the degrees of freedom increase, the *t* density curve approaches
  ...
  large.
:::
```{r fig:density-curves, echo=FALSE, fig.cap="Comparison of the standard normal distribution and t-distributions with 2 and 9 degrees of freedom.", out.width='80%', fig.align='center'}
knitr::include_graphics("Working Text/Section7/images/density_curves.png")
```
...
knitr::include_graphics("Working Text/Section7/images/tax_histogram.png")
```
:::
...
::: center
```{r echo=FALSE, fig.cap=" ", out.width='80%', fig.align='center'}
knitr::include_graphics("Working Text/Section7/images/tax_boxplot.png")
```
:::
...
::: center
```{r echo=FALSE, fig.cap=" ", out.width='80%', fig.align='center'}
knitr::include_graphics("Working Text/Section7/images/tax_qqplot.png")
```
:::
